...
```sh
$ git clone https://github.com/tazeembaig/ChatRoom.git
```
...
And of course ChatRoom itself is open source with a [public repository](https://github.com/tazeembaig/ChatRoom.git) on GitHub.
